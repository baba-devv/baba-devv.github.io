...
<br>
*Explore why UTF-8 encoding is dominant : [utf8everywhere](https://utf8everywhere.org){:target="_blank"}*
<br>
*Tokenization fundamentals - [Tokenization](https://youtu.be/zduSFxRajkE?si=_TIkEm-6uVk4E9Hi){:target="_blank"}*
